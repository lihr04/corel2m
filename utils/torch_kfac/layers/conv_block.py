...
class ConvFisherBlock(ExtensionFisherBlock):
    ...
    def update_cov(self, cov_ema_decay: float = 1.0, weight: float = 1.0) -> None:
        ...
        self._activations_cov.add_to_average(activation_cov, decay=cov_ema_decay, weight=weight)
        self._sensitivities_cov.add_to_average(sensitivity_cov, decay=cov_ema_decay, weight=weight)
